...
const INVESTOR_STEPS: Step[] = [
  {
    ...
    type: "choice",
    options: [
      { value: "now", label: "Ready to deploy now", emoji: "🟢" },
      { value: "3-6m", label: "Within 3 – 6 months", emoji: "🟡" },
      { value: "6-12m", label: "6 – 12 months", emoji: "🟠" },
      { value: "explore", label: "Exploring the market", emoji: "🔎" },
    ],
  },
  {
    key: "ticket",
    question: "Typical ticket size?",
    type: "choice",
    options: [
      { value: "lt50k", label: "Under $50K", emoji: "🌱" },
      { value: "50-250k", label: "$50K – $250K", emoji: "🌿" },
      { value: "250k-1m", label: "$250K – $1M", emoji: "🌳" },
      { value: "gt1m", label: "$1M+", emoji: "🏝️" },
    ],
  },
  {
    key: "industries",
    ...
    type: "multichoice",
    options: [
      { value: "hospitality", label: "Hotels & hospitality", emoji: "🏨" },
      { value: "f_and_b", label: "Food & beverage", emoji: "🍽️" },
      { value: "wellness", label: "Wellness & spa", emoji: "🧘" },
      { value: "real_estate", label: "Real estate / villas", emoji: "🏡" },
      { value: "transport", label: "Transport & logistics", emoji: "🚘" },
      { value: "digital", label: "Digital / tech / SaaS", emoji: "💻" },
      { value: "retail", label: "Retail & brands", emoji: "🛍️" },
    ],
  },
  {
    key: "vehicle",
    ...
    type: "choice",
    options: [
      { value: "equity", label: "Direct equity in operating businesses", emoji: "📈" },
      { value: "acquire", label: "Full acquisition / buy-out", emoji: "🏷️" },
      { value: "property", label: "Property / real estate", emoji: "🏡" },
      { value: "joint", label: "Joint venture with operators", emoji: "🤝" },
      { value: "open", label: "Open to the right deal", emoji: "✨" },
    ],
  },
  {
    key: "support",
    question: "Where do you need help?",
    subtitle: "We handle the unsexy side of investing in Indonesia.",
    type: "multichoice",
    options: [
      { value: "juris", label: "Jurisdiction & legal structure", emoji: "⚖️" },
      { value: "papers", label: "Visas, permits & paperwork", emoji: "📄" },
      { value: "team", label: "Hiring local team / operators", emoji: "👥" },
      { value: "dd", label: "Deal sourcing & due diligence", emoji: "🔍" },
      { value: "exit", label: "Exit strategy & tax", emoji: "🎯" },
    ],
  },
  {
    key: "residency",
    question: "Are you currently based in Indonesia?",
    type: "choice",
    options: [
      { value: "yes", label: "Yes, I'm here", emoji: "🇮🇩" },
      { value: "remote", label: "No, investing remotely", emoji: "🌍" },
      { value: "moving", label: "Planning to relocate", emoji: "✈️" },
    ],
  },
];
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="max-w-3xl mx-auto w-full px-6 pt-6">
        <div className="inline-flex items-center gap-1 p-1 rounded-full bg-sand text-xs font-medium">
          {(["traveler", "entrepreneur", "investor"] as Audience[]).map((a) => (
            <button
              key={a}
